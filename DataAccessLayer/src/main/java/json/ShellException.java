...
public class ShellException extends Exception
{
	 ...
	 * in a {@link json.ShellException}. This is because we can't rely on the
	 * client having the full classpath the server has.
	 * @param cause the {@link Throwable} to wrap in a {@link json.ShellException}.
	 * @return the {@link json.ShellException} wrapped around the {@code cause}.
	 */
